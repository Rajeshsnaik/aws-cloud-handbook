...
| **Folder**                                               | **Description**                                                                                                                                                                                                                                                                                                                                                                                |
| -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 📁 **[01-cloud-fundamentals](./01-cloud-fundamentals/)** | Cloud computing fundamentals, architecture principles, virtualization, deployment models, service models (IaaS, PaaS, SaaS), and core cloud concepts.                                                                                                                                                                                                                                          |
| 📁 **[02-VPC](./02-VPC/)**                               | Amazon VPC networking, CIDR blocks, public and private subnets, route tables, internet gateways, NAT gateways, security groups, NACLs, and VPC connectivity.                                                                                                                                                                                                                                   |
| 📁 **[03-IAM](./03-IAM/)**                               | AWS Identity and Access Management (IAM), users, groups, roles, policies, permissions, authentication, authorization, MFA, and security best practices.                                                                                                                                                                                                                                        |
| 📁 **[04-AWS-CLI](./04-AWS-CLI/)**                       | AWS Command Line Interface (CLI), installation, configuration, profiles, commands, automation, scripting, and AWS service management.                                                                                                                                                                                                                                                          |
| 📁 **[05-EC2](./05-EC2/)**                               | Amazon EC2 instances, AMIs, key pairs, networking, security groups, storage, Elastic IPs, scaling, monitoring, and instance management.                                                                                                                                                                                                                                                        |
...
| 📁 **[08-AWS-Databases](./08-AWS-Databases/)**           | Overview of AWS database services including Amazon RDS, DynamoDB, Aurora, ElastiCache, Redshift, Neptune, DocumentDB, Keyspaces, Timestream, QLDB, and other AWS database offerings.                                                                                                                                                                                                           |
| 📁 **[09-DynamoDB](./09-DynamoDB/)**                     | Amazon DynamoDB NoSQL database, tables, items, attributes, primary keys, secondary indexes, CRUD operations, capacity modes, consistency models, TTL, streams, transactions, global tables, backup & restore, security, monitoring, DAX, and Node.js integration.                                                                                                                              |
| 📁 **[10-RDS](./10-RDS/)**                               | Amazon RDS relational database service, supported database engines, DB instances, instance classes, storage types, Multi-AZ deployment, Read Replicas, backups, PITR, security, monitoring, scaling, connectivity, RDS Proxy, Amazon Aurora, pricing, best practices, and Node.js MySQL integration.                                                                                           |
